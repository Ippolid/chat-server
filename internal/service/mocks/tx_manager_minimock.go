...
//go:generate minimock -i github.com/Ippolid/platform_libary/pkg/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/Ippolid/platform_libary/pkg/db"
